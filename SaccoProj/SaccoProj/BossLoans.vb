...
Public Class BossLoans
    Dim MySqlConn As MySqlConnection
    Dim COMMAND As MySqlCommand
    Dim READER As MySqlDataReader
    Dim dbDataset As New DataTable

    Private Sub BossLoans_Closing(sender As System.Object, e As System.EventArgs) Handles MyBase.FormClosing
        Boss.Show()
    End Sub

    Private Sub BossLoans_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        meza()
        Ltype()
        Stats_Items()
    End Sub
